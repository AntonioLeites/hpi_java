...
// Um eine Bewegung zu erzeugen brauchen wir zunächst variable Werte
	...
	@Override
	public void setup() {
//    in der Setup Methode setzen wir die initialen Werte Die Position 0/0 entspricht der linken oberen Ecke des Fensters   
	  this.x = 0;
	  this.y = 0;	
...
//    Dieser erste Aufruf an dieser Stelle, ist allerdings zugegebenermaßen nicht wirklich notwendig.		
	...
	*/
	...
	public void draw() {
		...
		// Der Wert der x/y Position wird bei jedem Aufruf der draw() Methode um 1 erhöht. Gezeigt werden 3 alternative Schreibweisen.
		this.x = this.x + 1;
		this.y += 1;
		//this.y++;
	...
	private void drawRect(int x, int y) {				
		noStroke();
		fill(255, 10, 10);		
//Aufgabe 1:	rectMode(CENTER);        ->  rectMode(CORNER);
//Aufgabe 1:	rect(5, -100, 20, 10);	 ->  rect(5, 10, 20, 10);
		rectMode(CORNER);
//Aufgabe 2:		rect(5, 10, 20, 10); ->  rect(x, y, 10, 10);
		rect(x, y, 10, 10);
	}
